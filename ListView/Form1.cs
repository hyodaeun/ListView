    ...
    public partial class Form1 : Form
    {
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            if(TextCheck())
            {
                ...
                ListViewItem lvi = new ListViewItem(new string[] { this.strName, this.strAge, this.strWork });
        ...
        {
            ListViewItem lvi = this.lvView.SelectedItems[0]; //선택된 하나만 가져오기
            //lvi.SubItems[0];
            MessageBox.Show("이름 : " + lvi.SubItems[0].Text +
                            "\n나이 : " + lvi.SubItems[1].Text +
                            "\n직업 : " + lvi.SubItems[2].Text,
                            "선택 정보", MessageBoxButtons.OK,
